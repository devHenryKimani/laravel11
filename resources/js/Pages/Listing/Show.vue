      ...
      <Box>
        ...
        <div>
          ...
          <input
            ...
            class="w-full h-4 bg-blue-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700"
          ...
          <div class="mt-2 text-gray-500">
            ...
            <div class="flex justify-between">
              ...
              <div>
                <Price :price="totalIntrest" class="font-medium" />
              </div>
            </div>
          </div>
        </div>
...
const { monthlyPayment, totalPaid, totalIntrest } = useMonthlyPayment(
  props.listing.price, intrestRate, duration,
)
</script>